...
class CustomColors {
  static const Color DiademDark = Color.fromRGBO(66, 27, 155, 1);
  static const Color DiademMain = Color.fromRGBO(160, 110, 225, 1);
  static const Color DiademLight = Color.fromRGBO(203, 188, 246, 1);
  static const Color DiademGreen = Color.fromRGBO(206, 249, 226, 1);
  static const Color DiademRed = Color.fromRGBO(221, 104, 146, 1);
  static const Color DiademOriginal = Color.fromRGBO(81, 44, 150, 1);
